...
// request rest api
request_ns.rest_get = function (_url, _data, _success, _error, _before, _complete, _contentType, _cache, _async) {
    request_ns.common(main_globals.restApiUrl + _url, _data, request_ns.VERB_GET, _success, _error, _before, _complete, "json", _contentType, _cache, _async);
};

request_ns.rest_post = function (_url, _data, _success, _error, _before, _complete, _contentType, _cache, _async) {
    request_ns.common(main_globals.restApiUrl + _url, _data, request_ns.VERB_POST, _success, _error, _before, _complete, "json", _contentType, _cache, _async);
};

request_ns.rest_post2 = function (_url, _data, _success, _error, _before, _complete, _cache, _async) {
    request_ns.common(main_globals.restApiUrl + _url, JSON.stringify(_data), request_ns.VERB_POST, _success, _error, _before, _complete, "json", request_ns.CONTENT_TYPE_JSON, _cache, _async);
};

request_ns.rest_put = function (_url, _data, _success, _error, _before, _complete, _contentType, _cache, _async) {
    request_ns.common(main_globals.restApiUrl + _url, _data, request_ns.VERB_PUT, _success, _error, _before, _complete, "json", _contentType, _cache, _async);
};

request_ns.rest_put2 = function (_url, _data, _success, _error, _before, _complete, _cache, _async) {
    request_ns.common(main_globals.restApiUrl + _url, JSON.stringify(_data), request_ns.VERB_PUT, _success, _error, _before, _complete, "json", request_ns.CONTENT_TYPE_JSON, _cache, _async);
};

request_ns.rest_del = function (_url, _data, _success, _error, _before, _complete, _contentType, _cache, _async) {
    request_ns.common(main_globals.restApiUrl + _url, _data, request_ns.VERB_DEL, _success, _error, _before, _complete, "json", _contentType, _cache, _async);
};

request_ns.rest_del2 = function (_url, _data, _success, _error, _before, _complete, _cache, _async) {
    request_ns.common(main_globals.restApiUrl + _url, JSON.stringify(_data), request_ns.VERB_DEL, _success, _error, _before, _complete, "json", request_ns.CONTENT_TYPE_JSON, _cache, _async);
};
// request rest api
